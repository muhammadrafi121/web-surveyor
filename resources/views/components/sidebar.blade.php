<ul class="navbar-nav bg-white sidebar accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="inputdata.html" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
          <a class="nav-link" href="listdata.html">
